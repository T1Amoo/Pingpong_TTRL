#!/usr/bin/env bash
# Watchdog for g1_tt_v15 — SPEED curriculum, WARM-STARTED from v12 model_10000.
#
...
#   logs/g1_tt_v15/seed_v14/, warm-start with a FRESH optimizer (LOAD_OPTIMIZER=0; reward+curriculum
...
# --- one-time seed: copy v13 model_<SEED_ITER> into logs/g1_tt_v15/seed_v14/.
