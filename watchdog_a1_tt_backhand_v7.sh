...
# V7 inherits the audited v6 24 control steps * 10 physics substeps = 240
...
# predictor targets, and v7/v6 reward events are active independently of probes.
...
EXP=logs/a1_tt_backhand_real_v7_r108_readypose
TARGET=${A1_TT_TARGET:-19999}
TASK=a1_tt_backhand_v7
TRAIN_LOG=${A1_TT_TRAIN_LOG:-train_a1_tt_backhand_real_v7_r108_readypose.log}
WATCHDOG_LOG=${A1_TT_WATCHDOG_LOG:-train_a1_tt_backhand_real_v7_r108_readypose_watchdog.log}
TRAINER_PID_FILE=${A1_TT_TRAINER_PID_FILE:-train_a1_tt_backhand_v7_trainer.pid}
WATCHDOG_PID_FILE=${A1_TT_WATCHDOG_PID_FILE:-train_a1_tt_backhand_v7_watchdog.pid}
