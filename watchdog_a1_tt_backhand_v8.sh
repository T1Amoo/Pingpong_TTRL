...
# V8 is a from-scratch reward-only timing experiment.  It inherits v7's
# audited 24 control steps * 10 physics substeps = 240 raw steps per PPO
# iteration and the production 64-mini-batch optimizer.
...
# predictor targets, v7 collision safety and v8 reward terms stay active.
...
EXP=logs/a1_tt_backhand_real_v8_timing_wristquiet
TARGET=${A1_TT_TARGET:-19999}
TASK=a1_tt_backhand_v8
TRAIN_LOG=${A1_TT_TRAIN_LOG:-train_a1_tt_backhand_real_v8_timing_wristquiet.log}
WATCHDOG_LOG=${A1_TT_WATCHDOG_LOG:-train_a1_tt_backhand_real_v8_timing_wristquiet_watchdog.log}
TRAINER_PID_FILE=${A1_TT_TRAINER_PID_FILE:-train_a1_tt_backhand_v8_trainer.pid}
WATCHDOG_PID_FILE=${A1_TT_WATCHDOG_PID_FILE:-train_a1_tt_backhand_v8_watchdog.pid}
